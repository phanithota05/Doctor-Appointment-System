...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logo2.jpg" height="40px"></a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Providing expert specialized care in Cardiology, Dental, Neurology, ENT, Pediatrics, Nephrology, and more.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Easy Online Booking, Schedule Appointments Anytime Anywhere with Just a Few Clicks..</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Have questions or need assistance? Contact us for prompt and reliable support. We're here to help you.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Locate Our Hospitals Nearby</h4>
                            <p>Use our search tool to find the closest branches of our hospitals to your location, ensuring convenient access to our services.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Immediate Ambulance Services and Expert Medical Attention When You Need It Most, Anytime, Anywhere.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Your One-Stop Pharmacy</h4>
                            <p>Wide Range of Medicines Catering to All Ailments, Ensuring Your Health and Well-Being,Providing Comfort, Care, and Convenience..</p>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© PhaniThota <a href ="https://projectworlds.in/">check my website </a></p>
